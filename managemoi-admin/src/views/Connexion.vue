        ...
        async connexion() {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    store.state.user.token = response.token
                    store.state.user.roles = response.role
                    store.state.user.userDetail = response.admin
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Connectez-voous</h5>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" @submit.prevent="connexion">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <p class="text-danger" v-if="status">Entrez un email valide svp.</p>
                                        </div>
